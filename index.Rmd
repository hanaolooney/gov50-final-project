...
knitr::kable(filtered_data_distribution, col.names = c("Mean", "Standard Deviation"), digits = 3)
```
...
knitr::kable(subscribers_GOP_summary, col.names = c("Term", "Estimate", "Standard Error", "Statistic", "P-Value", "CI Lower Bound", "CI Upper Bound"), digits = 2)
```
...
knitr::kable(filtered_data_summary, col.names = c("Term", "Estimate", "Standard Error", "Statistic", "P-Value", "CI Lower Bound", "CI Upper Bound"), digits = 2)
```
...
knitr::kable(black_GOP_summary, col.names = c("Term", "Estimate", "Standard Error", "Statistic", "P-Value", "CI Lower Bound", "CI Upper Bound"), digits = 2)
```
...
knitr::kable(group_means, col.names = c("Fox News Indicator", "Average 1996 GOP Vote Share", "Average 2000 GOP Vote Share", "Change"), digits = 2)
```
...
knitr::kable(DiD_estimate, col.names = c("Differences-In-Differences Estimate"), digits = 2)
```
